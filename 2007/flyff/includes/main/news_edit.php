<?php
if ($_SESSION[rank] > 0) {
$sql = mysql_fetch_array(mysql_query("SELECT * FROM news WHERE id = '".$_GET[id]."' LIMIT 1"));
echo '
...
';
?>
<div class="title">Hír szerkesztése</div>
<br />
<br />
<?php
echo $comment.'
<form action="?a=main/do_news_edit&amp;id='.$_GET[id].'&amp;p=main/home" method="post">
<b>Hír neve: </b><br />
';
echo "<input type=\"text\" name=\"title\" id=\"title\" onBlur=\"test('title',3,100)\" value=\"".$sql[title]."\" style=\"width: 100%\" />";
?>
<br />
<br />
<b>Hír szövege: </b><br />
...
<td width="530px">
<textarea name="news" id="news" onBlur="test('news',3,1000)" style="width: 100%; height: 300px">
<?php echo $sql[text]; ?>
</textarea>
</td>
</tr></table>
